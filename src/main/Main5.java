 ...
 * ------------- Resultados -------------
 *
 * El cliente Pedro Perez compro exitosamente un plan Plan anual igual o menor a
 * 100.000 El cliente Pedro Perez ya tiene un plan activo El cliente Pedro Perez
 * compro exitosamente un plan Plan ilimitado anual El cliente Miguel Jimenez
 * compro exitosamente un plan Plan anual igual o menor a 100.000 El cliente
 * Gustavo Moradas compro exitosamente un plan Plan ilimitado anual El cliente
 * Pedro Perez registro exitosamente el curso Introduccion a GIS con PosGIS El
 * plan del cliente Miguel Jimenez no cubre el curso Introduccion a programacion
 * movil El cliente Miguel Jimenez compro exitosamente el curso Introduccion a
 * programacion movil El cliente Augusto Belalcazar no pago el valor correcto
 * por el curso Introduccion a programacion movil El cliente Augusto Belalcazar
 * compro exitosamente el curso Introduccion a programacion movil El cliente
 * Jose Camacho no pago el valor correcto por el curso Programacion Optima El
 * cliente Jose Camacho compro exitosamente el curso Programacion Optima El
 * cliente Gustavo Moradas registro exitosamente el curso Introduccion a Python
 * El cliente Gustavo Moradas registro exitosamente el curso Introduccion a
 * Bases de datos El cliente Gustavo Moradas registro exitosamente el curso
 * Programacion Optima El cliente Augusto Belalcazar compro exitosamente el
 * curso Introduccion a Python El cliente Pedro Perez ya habia registrado el
 * curso Introduccion a GIS con PosGIS El curso esta incluido en el plan del
 * cliente Pedro Perez, por lo tanto no debe pagar. Se procede a registrar el
 * curso Programacion Optima con costo $0 El cliente Miguel Jimenez ya habia
 * comprado el curso Introduccion a programacion movil El cliente Augusto
 * Belalcazar compro exitosamente el curso Introduccion a Bases de datos El
 * cliente Jose Camacho compro exitosamente el curso Introduccion a Bases de
 * datos El cliente Jose Camacho ya habia comprado el curso Introduccion a Bases
 * de datos El curso esta incluido en el plan del cliente Gustavo Moradas, por
 * lo tanto no debe pagar. Se procede a registrar el curso Gerencia de proyectos
 * con costo $0 El cliente Miguel Jimenez registro exitosamente el curso
 * Programacion Optima El cliente Miguel Jimenez compro exitosamente el curso
 * Introduccion a programacion web El cliente Miguel Jimenez compro exitosamente
 * el curso Gerencia de proyectos
 *
 * ---------------------------------------- El cliente que mas ha pagado en
 * efectivo por cursos es Miguel Jimenez
 * ----------------------------------------
 *
 * ------------- BONIFICACION ------------- Lista de clientes con sus compras:
 * ---------------------------------------- Pedro Perez Planes: Plan anual igual
 * o menor a 100.000 2023-04-22 500000.0 False Plan ilimitado anual 2023-04-22
 * 2000000.0 True
 *
 * Cursos: Introduccion a GIS con PosGIS 2023-04-22 0.0 True Programacion Optima
 * 2023-04-22 0.0 True ---------------------------------------- Miguel Jimenez
 * Planes: Plan anual igual o menor a 100.000 2023-04-22 500000.0 True
 *
 * Cursos: Introduccion a programacion movil 2023-04-22 150000.0 True
 * Programacion Optima 2023-04-22 0.0 True Introduccion a programacion web
 * 2023-04-22 150000.0 True Gerencia de proyectos 2023-04-22 150000.0 True
 * ---------------------------------------- Augusto Belalcazar Planes:
 *
 * Cursos: Introduccion a programacion movil 2023-04-22 150000.0 True
 * Introduccion a Python 2023-04-22 100000.0 True Introduccion a Bases de datos
 * 2023-04-22 100000.0 True ---------------------------------------- Jose
 * Camacho Planes:
 *
 * Cursos: Programacion Optima 2023-04-22 100000.0 True Introduccion a Bases de
 * datos 2023-04-22 100000.0 True ----------------------------------------
 * Gustavo Moradas Planes: Plan ilimitado anual 2023-04-22 2000000.0 True
 *
 * Cursos: Introduccion a Python 2023-04-22 0.0 True Introduccion a Bases de
 * datos 2023-04-22 0.0 True Programacion Optima 2023-04-22 0.0 True Gerencia de
 * proyectos 2023-04-22 0.0 True
 */
